...
export const IconPlay = ({ handleClick }) => {
  return (
    <span
      onClick={handleClick}
      className="play cursor-pointer flex items-center justify-center font-normal absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] lg:w-20 lg:h-10 xs:w-16 xs:h-8 py-2 flex-center-col text-center border-2 rounded-lg hover:bg-[#B78B67] transition-all ease duration-300 border-[#B78B67]"
    >
      <svg
