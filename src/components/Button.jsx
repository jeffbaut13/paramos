const Button = ({ handleClick, text }) => {
  return (
    <button
      onClick={handleClick}
      className="btnconoce uppercase tracking-[0.3em] flex items-center justify-center font-normal px-5 py-3 mt-4 flex-center-col text-center lg:text-2xl xs:text-xs border-2 rounded-lg hover:bg-[#B78B67] transition-all ease-in-out duration-300 border-[#B78B67] text-black hover:text-white"
