...
import VideoComponent from "./videclud";
  ...
  return (
    <div className="dosmilFrailejones flex relative h-full p-8">
      ...
      <div className="BoxDosmilTexto BoxesTextEnd flex-center z-0 relative">
        <p className="PrimerTextoDosmil font-bold uppercase text-6xl tracking-widest whitespace-nowrap">
        ...
        <p className="SegundoTextoDosmil font-bold uppercase text-6xl tracking-widest whitespace-nowrap">
          {numFrailejon == 1 && (
